    ...
    <div className="mt-10 text-white">
      ...
      {!isGold ? (
        <div className="bg-[#1A2742] rounded-2xl border border-amber-400 p-6">
          ...
          <div className="mt-8">
            <PremiumLock
              title="दशा संधि मिलान की पूरी जानकारी के लिए"
            />
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mt-8">
            ...
            <div className="bg-[#243454] rounded-xl p-6 border border-blue-400">
              ...
              <div className="mt-5 space-y-3">
                <p>
                  <span className="text-amber-400">वर्तमान दशा :</span>{" "}
                  {dashaSandhi.boy_sandhi.current_dasha}
                </p>

                <p>
                  <span className="text-amber-400">अगली दशा :</span>{" "}
                  {dashaSandhi.boy_sandhi.next_dasha}
                </p>

                <p>
                  <span className="text-amber-400">संधि प्रारंभ :</span>{" "}
                  {dashaSandhi.boy_sandhi.sandhi_start}
                </p>

                <p>
                  <span className="text-amber-400">संधि समाप्त :</span>{" "}
