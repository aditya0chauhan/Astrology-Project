  ...
  const sandhiMilan = async () => {
    try {
      ...
      const response = await fetch(
        `https://api.jyotishamastroapi.com/api/matching/dasha-sandhi?boy_dob=${boyDob}&boy_tob=${boyData.time}&boy_lat=${boyData.latitude}&boy_lon=${boyData.longitude}&boy_tz=5.5&girl_dob=${girlDob}&girl_tob=${girlData.time}&girl_lat=${girlData.latitude}&girl_lon=${girlData.longitude}&girl_tz=5.5&lang=hi`,
        {
          headers: {
