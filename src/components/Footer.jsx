        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <div className="space-y-3 text-slate-300">
              <p className="  flex items-center  hover:text-[#4285F4]"><IoCallOutline size={16} className="mr-1" /> <a  className='hover:underline '  href="tel:+91 88825 32259">Call Now →</a></p>
              ...
              <p className=" flex items-center hover:text-red-300 "><CiLocationOn size={18} className="mr-1" /><a className='hover:underline flex ' href="https://maps.app.goo.gl/aCPczyQgJWPnFoKE8?g_st=aw">Location →</a></p>
            </div>
          </div>
