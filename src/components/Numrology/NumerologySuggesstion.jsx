...
const NumerologySuggesstion = ({ userData }) => {
    ...
    return (
        ...
        <div className="border border-yellow-500 rounded-2xl -5 mb-6 bg-[#020817]">  
        ...
        {
            data.rudraksha?.rudraksha_description?.map((item, index) => (

                <p key={index} className="text-gray-300 leading-8 mb-3 ">
    ...
    <div className="max-w-6xl mx-auto bg-[#050b20] border border-yellow-500 rounded-3xl p-8 my-10">
        ...
        <h2 className="ext-center text-3xl font-bold text-yellow-400 mb-10 ">
            🔮 Numerology Analysis
        </h2>
