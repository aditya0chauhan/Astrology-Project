    ...
    const fetchPlanets = async () => {
        ...
        try {
            ...
            const response = await fetch(
                `https://api.jyotishamastroapi.com/api/lalKitab/planets?date=${formattedDate}&time=${userData.time}&latitude=${userData.latitude}&longitude=${userData.longitude}&tz=5.5&lang=hi`,
                {
                    headers: {
