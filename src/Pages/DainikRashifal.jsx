    ...
    const getRashifal = async () => {
        try {
            ...
            const response = await fetch(
                `https://api.jyotishamastroapi.com/api/prediction/daily?zodiac=${zodicNumber}&day=today&lang=hi`,
                {
                    headers: {
        ...
        <div className="mt-24 min-h-screen bg-[#0a0a0a] text-white px-5 py-10">
            ...
            <div className="max-w-3xl mx-auto bg-white/10 p-6 rounded-2xl space-y-5">
               <h1 className="text-3xl text-yellow-400 font-bold text-center">
                 {rashi} राशिफल
                   ...
                   <p>
                  📅 {rashifal.response.date}
                        </p>

               <div>
                  <h2 className="text-green-400 text-xl">आज का राशिफल</h2>
            ...
            <div className="grid grid-cols-2 gap-4">
                ...
                <Card
                   ...
                   <p>🎨 शुभ रंग :<span className="text-yellow-300">
                        {rashifal.response.color}
                            </span></p>

                        <p>🔢 शुभ अंक :
                    <span className="text-yellow-300">{rashifal.response.lucky_number}
                            </span></p>
                    </div>
                )
            }
