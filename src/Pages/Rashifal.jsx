...
const Rashifal = () => {
  return (
    <div className='mt-24 p-10'>
      <div className='mt-5 w-full lg:w-[40%] flex flex-col justify-between p-3 rounded-4xl border-2 border-amber-300 text-white text-center bg-gradient-to-r from-[#111827] to-[#0a0a0a]'>
